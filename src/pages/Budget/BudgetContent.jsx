                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody>
                        ...
                        <tr className="w-full flex justify-center gap-8 bg-rose-100">
                          ...
                          <td className="py-2 w-1/5"></td>
                          <td className="py-2 w-1/5"></td>
                          <td className="py-2 w-1/5 text-center">{isNaN(subTotal) ? "$0.00" : Intl.NumberFormat("es-CO", {style: "currency",currency: "COP",}).format(subTotal)}</td>
                          <td className="py-2 w-1/5 text-center">
